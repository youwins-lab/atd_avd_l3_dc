...
| Ethernet4 | SERVER_s2-host1_Ethernet2 | *trunk | *10,20 | *- | *- | 4 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet2 | P2P_s2-spine1_Ethernet3 | - | 10.255.1.205/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_s2-spine2_Ethernet3 | - | 10.255.1.207/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | --------------------- | ------------------ | ------- | -------- |
| Port-Channel4 | SERVER_s2-host1 | trunk | 10,20 | - | - | - | - | 4 | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.1.0.116/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.1.1.114/32 |
...
router bgp 65101
   ...
   neighbor 192.1.1.226 description s2-leaf1_Vlan4093
   ...
   vrf A
      ...
      neighbor 192.2.2.226 description s2-leaf1_Vlan4001
