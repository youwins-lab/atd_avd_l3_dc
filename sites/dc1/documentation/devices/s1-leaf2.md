...
| Ethernet4 | SERVER_s1-host1_Ethernet2 | *trunk | *10,20 | *- | *- | 4 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet2 | P2P_s1-spine1_Ethernet3 | - | 10.255.0.61/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_s1-spine2_Ethernet3 | - | 10.255.0.63/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.1.0.16/32 |
...
router bgp 65001
   ...
   neighbor 192.1.1.26 description s1-leaf1_Vlan4093
   ...
   vrf A
      ...
      neighbor 192.2.2.26 description s1-leaf1_Vlan4001
